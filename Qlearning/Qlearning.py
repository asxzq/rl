...
class Qlearning(object):
    ...
    def save(self):
        import dill
        torch.save(obj=self.Q_table, f="Qleaning_model.pkl", pickle_module=dill)
        print("保存模型成功！")

    def load(self):
        import dill
        self.Q_table = torch.load(f= 'Qleaning_model.pkl', pickle_module=dill)
        print("加载模型成功！")