...
class TD3Config:
	def __init__(self) -> None:
		...
		self.seed = 0
		self.result_path = "results/" +self.env+'/results/'  # path to save results
		self.model_path = "results/" +self.env+'/models/'  # path to save models
...
if __name__ == "__main__":
	...
	cfg.model_path = './results/Pendulum-v0/models/'
	cfg.result_path = './results/Pendulum-v0/results/'
