...
class Net(nn.Module):
    ...
    def choose_action(self, s):
        ...
        #print(mu)
        #print(sigma)
        m = self.distribution(mu[0].data, torch.from_numpy(np.diag(sigma[0].data)) )
    ...
    def loss_func(self, s, a, v_t):
        ...
        m = self.distribution(mu, torch.from_numpy(np.diag(sigma[0].data)))
        ...
        while self.g_ep.value < TRAIN_MAX_EP:
            ...
            if ep_r > self.lnet.max_r:
                ...
                if ep_r > self.gnet.max_r:
                    ...
                    print("save: max_ep_r", ep_r)
                    self.gnet.save(path='max.pth')
        print("while done")
